<template>
    <div class="storeManagement" ref="ctn">
      <div class="listContainer">
        <div>
          <div class="listItem" v-for="(s,index) in caogaoStore" :key="s.id" @click="isSwichHide(index,'grounding')">
              <div class="info">
              ...
              <div class="tools">
                <button @click.stop="isSwichHide(index,'grounding')" ref="whichselect" :value="index">上架</button>
                <button class="singledelete" ref="whichsingselect" :value="index" @click.stop="isSwichHide(index,'delete')">删除</button>
              </div>
          </div>
        </div>
      </div>
