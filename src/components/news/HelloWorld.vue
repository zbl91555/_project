  ...
  <div>
    <div class="hello" v-if="page">
      ...
      <div class="content">
        ...
        <div class="content1" v-for="item in recentSessMap" :key="item" @click="toletter(item.SessionId,item.SessionNick,item.SessionImage)">
    ...
    <div v-if="!page" class="letter">
      ...
      <div class="footer" ref="footer">
        ...
        <div class="emotion" v-if="emotionFlag">
          <img :src="item[1]" v-for="item in emotions" :key="item" @click="selectEmotion(item[0])">
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    login () {
      ...
      let addMsg = function (msg) {
        ...
        // 如果是发给自己的消息
        if (!isSelfSend) { _this.name = fromAccountNick }
            ...
            for (var i in resp.SessionItem) {
              ...
              if (!tempSess) {
                ...
                if (new Date(time).getDate() === new Date().getDate()) {
                  ...
                  new Date(time).getDate() - new Date().getDate() === 1
                ) {
                  time = '昨天'
                } else {
